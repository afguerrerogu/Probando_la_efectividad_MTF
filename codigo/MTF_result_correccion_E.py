...
ex=e_field['ex'] ; ey=e_field['ey'] ;  ez=e_field['ez'] ;
...
ex_i, ey_i, ez_i = ch_read.chunk_reader_h(ex,ey,ez,n,2)
...
e_mag_i = np.sqrt(ex_i*ex_i + ey_i*ey_i + ez_i*ez_i)
...
B_11,E_11 = MTF.extract_data(hx_i, hy_i, hz_i,ex_i, ey_i, ez_i,path_11)
B_12,E_12 = MTF.extract_data(hx_i, hy_i, hz_i,ex_i, ey_i, ez_i,path_12)
B_13,E_13 = MTF.extract_data(hx_i, hy_i, hz_i,ex_i, ey_i, ez_i,path_13)
B_14,E_14 = MTF.extract_data(hx_i, hy_i, hz_i,ex_i, ey_i, ez_i,path_14)
...
U_psi_L, U_psi_N = MTF.U_psi(zona,vec,e_mag_i,ex_i,ey_i,ez_i,hx_i,hy_i,hz_i)
U_div1 = MTF.divergence(U_psi_L,U_psi_N,e_mag_i)
